...
namespace TestesDonaMarina.ModulosTeste
{
    public class ControladorTeste : ControladorBase
    {
        ...
        {
            TelaCriacaoTesteForm tela = new TelaCriacaoTesteForm(repositorioDisciplina, repositorioMateria, repositorioQuestao);
        ...
        public void GerarPdf()
        {
            ...
            if (resultado == DialogResult.OK)
            {
                ...
                if (sfd.ShowDialog() == DialogResult.OK)
                {
                    ...
                    Paragraph materia = new Paragraph($"Matéria: {testeSelecionado.Materia.NomeMateria}");
